...
public class StringAPIMethodsDemo {
	public static void main(String[] args) {
		...
		System.out.println("".isEmpty()); // "" e un string gol
		System.out.println(" ".isEmpty()); // whitespace e un caracter in sine
		/* ---------------------------------------------------------------------------- */
		...
		System.out.println("Suma in Ron: " + sumaCaString);
		System.out.println("Suma in Ron1: " + sumaCaString1);
